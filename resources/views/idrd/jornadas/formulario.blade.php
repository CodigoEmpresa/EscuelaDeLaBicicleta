                ...
                <div class="row">
                    ...
                    <div class="col-md-3 form-group">
                        ...
                        <select class="form-control" name="Destreza_Inicial_Usuario" title="Seleccionar" required>
                            ...
                            <option value="D">D - Se impulsa y mantiene equilibrio</option>
                            <option value="E">E - Pedalea con apoyo</option>
                            <option value="F">F - Pedalea y mantiene equilibrio por instantes</option>
                            <option value="G">G - Maneja la bicicleta con apoyo</option>
